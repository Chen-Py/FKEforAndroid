import FKEServer.ServerBase.pyDes
...
def encrypt(data, key, iv):
    ...
    data = data.encode()
    k = FKEServer.ServerBase.pyDes.triple_des(key, FKEServer.ServerBase.pyDes.CBC, iv, pad=None, padmode=FKEServer.ServerBase.pyDes.PAD_PKCS5)
    res = k.encrypt(data)
    return res
